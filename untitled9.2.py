...
#         muX = Px - h*fun.f1(Px,Py); muX2s.append(sigmaX)
#         muY = Py - h*fun.f2(Px,Py); muY2s.append(sigmaY)
#         sigmaX = np.sqrt(h)*fun.g1(); sigmaX2s.append(sigmaX)
#         sigmaY = np.sqrt(h)*fun.g2(); sigmaY2s.append(sigmaY)
