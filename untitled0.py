...
def getLejaPoints(num_leja_samples, initial_samples, num_candidate_samples = 5000, dimensions=2):
    num_vars=2
    degree=30
...
def getLejaPointsWithStartingPoints(Px, Py, numNeighbors, mesh, numNewLejaPoints, scaleX, scaleY):
    ...
    lejaPointsFinal, newLeja = getLejaPoints(numNewLejaPoints+numNeighbors+1, intialPoints.T)
...
def generateLejaMesh(numPoints):
    lejaPoints, newPoints = getLejaPointsWithStartingPoints(0, 0, 0,[], numPoints)
    return lejaPoints
