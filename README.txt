...
The inputs for the procedure:
 ...
 - degree (beta in paper): Used to adjust the accuracy of the method by maintianing boundary points. A larger value means more accuracy but greater cost.
...
Sample drift and diffustion functions for the methods are set in the file DriftDiffFunctionBank.py and they can be imported for use. You can also write your own functions. 
